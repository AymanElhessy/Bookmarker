...
function displayBookmark(indexOfWebsite) {
  ...
  //delete buttons every time a new bookmark being added
  ...
  // visit buttons every time a new bookmark being added
...
// validate user enter the correct data
...
// how to close model(close button -  Esc key - clicking outside modal)
